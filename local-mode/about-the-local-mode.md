...
Local mode is intended to use with datashare services (elasticsearch, redis, database, etc.) launched by the user on the local machine.

Read more about the [Embedded mode](embedded-mode.md).
