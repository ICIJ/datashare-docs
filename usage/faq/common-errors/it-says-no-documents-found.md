...
<figure><img src="../../../.gitbook/assets/usage/faq/common-errors/it-says-no-documents-found/02-task-page-add-document-where-header.png" alt="Screenshot of Datashare&#x27;s task page to add document where the header of the Progress column is highlighted"><figcaption></figcaption></figure>
