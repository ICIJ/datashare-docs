...
You cannot start a query with AND all uppercase. [AND is reserved as a search operator](/usage/search-with-operators#and).
...
You cannot start a query with OR all uppercase. [OR is reserved as a search operator](/usage/search-with-operators#or-or-space).
...
‌You cannot start or type a query with only one double quote. [Double quotes are reserved as a search operator](/usage/search-with-operators#exact-phrase) for exact phrase.
...
‌You cannot start or type a query with only one parenthesis. [Parenthesis are reserved for combining operators](/usage/search-with-operators#please-note-that-you-can-combine-operators).
...
You cannot end a query with question mark (!). [Question mark is reserved as a search operator for excluding a term](/usage/search-with-operators#not-or).
...
‌You cannot start a query with caret (^) or write one which contains caret. [Caret is reserved as a boosting operator](/usage/search-with-operators#boosting-operators).
...
You cannot use square brackets [except for searching for ranges](/usage/search-with-operators#advanced-searches-using-metadata-fields).
